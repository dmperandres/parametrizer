...
template <class Type> _vertex3<Type> &_vertex3<Type>::operator()(const _vertex4<Type> &Vertex1)
{
  x=Vertex1.x;
  y=Vertex1.y;
  z=Vertex1.z;
...
template <class Type> _vertex3<Type> &_vertex3<Type>::operator()(Type *Vertices1)
{
  x=Vertices1[0];
  y=Vertices1[1];
  z=Vertices1[2];
...
template <class Type> _vertex3<Type> _vertex3<Type>::operator*(_matrix4<Type> &Matrix1)
{
  _vertex3<Type> VertexTemp(*this);
...
template <class Type> _vertex3<Type> _vertex3<Type>::cross_product(const _vertex3<Type> &Vertex1)
{
...
template <class Type> bool _vertex3<Type>::operator==(const _vertex3<Type> &Vertex1)
{
...
template <class Type> bool _vertex3<Type>::operator==(const _vertex2<Type> &Vertex1)
{
  if (x==Vertex1.x && y==Vertex1.y) return true;
  return false;
}
...
template <class Type> bool _vertex3<Type>::equal_coordinates(int Num_coordinates1)
{
...
template <class Type> _vertex3<Type> &_vertex3<Type>::from_byte(_vertex3<unsigned char> &Vertex1)
{
...
template <class Type> Type _vertex3<Type>::compute_angle(const _vertex3<Type> &Vertex1)
{
  _vertex3f Auxiliar;
  float cosine,sine;
...
template <class Type> _vertex4<Type> &_vertex4<Type>::operator()(Type x1,Type y1,Type z1,Type w1)
{
  x=x1;
  y=y1;
  z=z1;
...
template <class Type> _vertex4<Type> &_vertex4<Type>::operator()(const _vertex2<Type> &Vertex1)
{
  x=Vertex1.x;
  y=Vertex1.y;
  return(*this);
...
template <class Type> _vertex4<Type> &_vertex4<Type>::operator()(const _vertex3<Type> &Vertex1)
{
  x=Vertex1.x;
  y=Vertex1.y;
  z=Vertex1.z;
...
template <class Type> _vertex4<Type> &_vertex4<Type>::operator()(const _vertex4<Type> &Vertex1)
{
  x=Vertex1.x;
  y=Vertex1.y;
  z=Vertex1.z;
...
template <class Type> _vertex4<Type> &_vertex4<Type>::operator()(Type *Vertices1)
{
  x=Vertices1[0];
  y=Vertices1[1];
  z=Vertices1[2];
...
template <class Type> _vertex4<Type> _vertex4<Type>::operator*(_matrix4<Type> &Mat1)
{
...
template <class Type> bool _vertex4<Type>::operator==(const _vertex4<Type> &Vertex1)
{
...
template <class Type> _vertex4<Type> &_vertex4<Type>::from_byte(_vertex4<unsigned char> &Vertex1)
{
  r=Type(Vertex1.r)/Type(255.);
  g=Type(Vertex1.g)/Type(255.);
  b=Type(Vertex1.b)/Type(255.);
...
template <class Type> _plane<Type> &_plane<Type>::operator=(_plane<Type> &Plane1)
{
  this->x=Plane1.x;
  this->y=Plane1.y;
  this->z=Plane1.z;
...
template <class Type> int	_plane<Type>::compute_coefficients(_vertex3<Type> Vertex1,_vertex3<Type> Vertex2,_vertex3<Type> Vertex3)
{
...
template <class Type> _bounding_box3<Type>::_bounding_box3(Type Xmin1,Type Ymin1, Type Zmin1, Type Xmax1, Type Ymax1, Type Zmax1)
{
  Minimum.x=Xmin1;
  Minimum.y=Ymin1;
  Minimum.z=Zmin1;
...
template <class Type> _bounding_box3<Type>::_bounding_box3(const _bounding_box3<Type> &Bounding_box1)
{
...
template <class Type> _bounding_box3<Type> _bounding_box3<Type>::compute(const _vertex3<Type> &Vertex1)
{
...
template <class Type> _bounding_box3<Type> _bounding_box3<Type>::compute(_bounding_box3<Type> &Bounding_box1)
{
